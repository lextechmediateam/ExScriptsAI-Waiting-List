...
export default function App() {
  ...
  const handleConfirmConsent = async () => {
    ...
    const apiURL =
      import.meta.env.VITE_API_URL || "http://localhost:8080/api/waitlist";
  ...
  return (
    <>
          ...
          >
            ...
            <div className="modal-body">
              ...
              <p className="modal-sub">
                Please confirm your preferences below to continue.
              </p>
              ...
              <div className={`consent-item ${consentLaunch ? "checked" : ""}`}>
                ...
                <label htmlFor="consent-launch">
                  I agree to receive a launch notification email from ExScripts
                  / LexTech Ecosystem Limited when the product becomes
                  available.
              ...
              <div
                className={`consent-item ${consentMarketing ? "checked" : ""}`}
              >
                <input
                  type="checkbox"
                ...
                <label htmlFor="consent-marketing">
                  ...
                  communications about ExScripts, including feature
                  announcements, early-access offers, and pricing information.
              ...
              <div className="modal-footer">
                ...
                <a href="mailto:privacy@lextechgroup.com">
                  privacy@lextechgroup.com
                </a>
              </div>
            </div>
          </div>
      ...
      <main>
        ...
        <div className="stats">
          <div className="stat">
            <div className="num">Free Sign Up</div>
        ...
        <div className="features">
          <div className="feat">
            <span className="feat-dot"></span>99%+ Accuracy
          </div>
          <div className="feat">
            <span className="feat-dot"></span>Multi-language support
          </div>
          <div className="feat">
            <span className="feat-dot"></span>Real-time transcription
          </div>
          <div className="feat">
            <span className="feat-dot"></span>Speaker identification
          </div>
          <div className="feat">
            <span className="feat-dot"></span>Export to any format
          </div>
        </div>
      </main>
